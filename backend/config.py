...
LLM_MODEL = os.getenv("LLM_MODEL", "chatgpt-5.4-mini")

# Three-tier model routing — ML ensemble (local) → encoder-proxy (batch) → decoder (interactive)
LLM_MODEL_BATCH = os.getenv("LLM_MODEL_BATCH", "chatgpt-5.4-mini")          # Used during seed (analyze_supplier, detect_text_similarity)
LLM_MODEL_INTERACTIVE = os.getenv("LLM_MODEL_INTERACTIVE", "chatgpt-5.4-mini")   # Used for AI Query, cluster analysis
